...
{	
	...
	public class AIFollower : MonoBehaviour 
	{
		...
		[Header("Distances")]
		[Information("Add this script to a CharacterBehavior+CorgiController2D object to make it follow (or try to follow) the GameObject with a 'Player' tag.",MoreMountains.Tools.InformationAttribute.InformationType.Info,false)]
